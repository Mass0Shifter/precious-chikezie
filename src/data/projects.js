...
export const projects = [
  ...
  },
  {
    ...
    status: "Confidential",
    overview: "(NDA Protected) A proprietary construction estimation tool for the glass industry. Engineered a Direct Manipulation interface using Flutter where users drag-and-drop components to automate estimation. Hosted on AWS for scalable, reliable delivery.",
    ...
    solution: "Developed a Flutter app with a drag-and-drop interface that lets users compose glazing layouts visually. The system auto-calculates materials, labor, and margins while maintaining a library of standard components. Backend and web assets are deployed on AWS for hosting, CI-friendly releases, and production-grade uptime.",
    myRole: ["Lead developer", "Flutter architecture", "Algorithm design", "AWS deployment & hosting"],
    screenshots: [
      { src: "/projects/workings-1.png", caption: "Projects Page" },
      { src: "/projects/workings-2.png", caption: "Materials List Page" },
    ],
    tech: ["Flutter", "React", "Node.js", "Algorithms", "AWS"],
